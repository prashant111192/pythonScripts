...
def plot_graph(x: "ndarray", y: "ndarray", c_: "ndarray", name: str, title: str) -> None:
    """TODO."""
...
def plot_2_together(piv_arr: "ndarray", sph_arr: "ndarray", closest: "ndarray", name: str, title: str) -> None:
    """TODO."""
    ...
    plt.savefig(f"./figs/{title}{name}.png")
    plt.clf()
    # plt.savefig("./fig.png")
    # plt.show()
...
def main() -> None:
    ...
    for idx in range(12):
        ...
        # plot_2_together(shifted_height, sph_arr, closest_index_sph)
        # plot_2_together(data, sph_arr, closest_index_sph)
        # plot_graph(data[:,0,0], data[:,1,0], percent, heights_array[idx], "percent")
        outliers_idx = quartile_range(percent)
        closest_pts = np.copy(sph_arr[closest_index_sph, :])
        plot_2_together(shifted_height, closest_pts, outliers_idx, heights_array[idx], "outliers")
